...

{
  dconf.settings = {
    ...
    "org/gnome/desktop/notifications" = {
      application-children = [ "code" "org-kde-kdeconnect-daemon" "qq" "vivaldi-stable" "org-gnome-nautilus" "org-telegram-desktop" "gnome-power-panel" "org-gnome-console" "arduino" "thunderbird" "wemeetapp" "gnome-network-panel" "fish" "org-gnome-shell-extensions" "clash-verge" "org-gnome-settings" "firefox" "element-desktop" "org-gnome-totem" "netease-cloud-music" "xdg-desktop-portal-gnome" "startcenter" "draw" "zotero" "discord" "steam" "android-studio" "org-gnome-eog" "org-gnome-extensions-desktop" "idea-community" "org-gnome-epiphany" ];
      show-banners = true;
    };
    ...
    "org/gnome/desktop/notifications/application/netease-cloud-music" = {
      application-id = "netease-cloud-music.desktop";
    };
    ...
    "org/gnome/shell" = {
      ...
      enabled-extensions = [ "improvedosk@nick-shmyrev.dev" "screen-rotate@shyzus.github.io" "osktouchpad@francescocaracciolo.uno" "trayIconsReloaded@selfmade.pl" "topiconsfix@aleskva@devnullmail.com" "appindicatorsupport@rgcjonas.gmail.com" "forge@jmmaranan.com" "blur-my-shell@aunetx" "tiling-assistant@leleat-on-github" "launch-new-instance@gnome-shell-extensions.gcampax.github.com" "native-window-placement@gnome-shell-extensions.gcampax.github.com" "places-menu@gnome-shell-extensions.gcampax.github.com" "windowgestures@extension.amarullz.com" "kimpanel@kde.org" "swap-finger-gestures-3-4@icedman.github.com" "disable-gestures-2021@verycrazydog.gmail.com" ];
