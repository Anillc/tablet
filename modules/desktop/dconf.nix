...

{
  dconf.settings = {
    ...
    "org/gnome/desktop/notifications" = {
      application-children = [ "code" "org-kde-kdeconnect-daemon" "qq" "vivaldi-stable" "org-gnome-nautilus" "org-telegram-desktop" "gnome-power-panel" "org-gnome-console" "thunderbird" "wemeetapp" "gnome-network-panel" "fish" "org-gnome-shell-extensions" "org-gnome-settings" "firefox" "element-desktop" "org-gnome-totem" "xdg-desktop-portal-gnome" "startcenter" "draw" "zotero" "discord" "android-studio" "org-gnome-eog" "org-gnome-extensions-desktop" "idea-community" "org-gnome-epiphany" ];
      show-banners = true;
    };
